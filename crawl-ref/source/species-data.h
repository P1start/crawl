...
{ SP_GROUND_DWARF, {
    ...
    11, 8, 8, // 27
    { STAT_STR, STAT_INT }, 4,
    { { MUT_FORLORN, 1, 1 }, { MUT_PASSIVE_MAPPING, 1, 1 }, { MUT_PASSIVE_MAPPING, 1, 9 },
      { MUT_PASSIVE_MAPPING, 1, 18 }, },
    { "You do not waste unidentified wand charges.", "You can freely remove cursed items.",
      "You are permanently silenced." },
    { "wand affinity", "curse immunity", "permanent silence" },
