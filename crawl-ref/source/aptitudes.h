...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_GROUND_DWARF
    APT(SP_GROUND_DWARF,      SK_FIGHTING,       -1),
    APT(SP_GROUND_DWARF,      SK_SHORT_BLADES,   -1),
    APT(SP_GROUND_DWARF,      SK_LONG_BLADES,     0),
    APT(SP_GROUND_DWARF,      SK_AXES,            1),
    APT(SP_GROUND_DWARF,      SK_MACES_FLAILS,    0),
    APT(SP_GROUND_DWARF,      SK_POLEARMS,       -1),
    APT(SP_GROUND_DWARF,      SK_STAVES,         -1),
    APT(SP_GROUND_DWARF,      SK_SLINGS,          1),
    APT(SP_GROUND_DWARF,      SK_BOWS,           -3),
    APT(SP_GROUND_DWARF,      SK_CROSSBOWS,       1),
    APT(SP_GROUND_DWARF,      SK_THROWING,       -1),
    APT(SP_GROUND_DWARF,      SK_ARMOUR,          1),
    APT(SP_GROUND_DWARF,      SK_DODGING,         1),
    APT(SP_GROUND_DWARF,      SK_STEALTH,         3),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GROUND_DWARF,      SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_GROUND_DWARF,      SK_SHIELDS,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GROUND_DWARF,      SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_GROUND_DWARF,      SK_UNARMED_COMBAT, -1),
    APT(SP_GROUND_DWARF,      SK_SPELLCASTING,   -2),
    APT(SP_GROUND_DWARF,      SK_CONJURATIONS,   -1),
    APT(SP_GROUND_DWARF,      SK_HEXES,          -2),
    APT(SP_GROUND_DWARF,      SK_CHARMS,         -1),
    APT(SP_GROUND_DWARF,      SK_SUMMONINGS,     -1),
    APT(SP_GROUND_DWARF,      SK_NECROMANCY,      1),
    APT(SP_GROUND_DWARF,      SK_TRANSLOCATIONS,  1),
    APT(SP_GROUND_DWARF,      SK_TRANSMUTATIONS, -1),
    APT(SP_GROUND_DWARF,      SK_FIRE_MAGIC,     -1),
    APT(SP_GROUND_DWARF,      SK_ICE_MAGIC,      -1),
    APT(SP_GROUND_DWARF,      SK_AIR_MAGIC,      -3),
    APT(SP_GROUND_DWARF,      SK_EARTH_MAGIC,     3),
    APT(SP_GROUND_DWARF,      SK_POISON_MAGIC,   -2),
    APT(SP_GROUND_DWARF,      SK_INVOCATIONS,     5),
    APT(SP_GROUND_DWARF,      SK_EVOCATIONS,      3),
